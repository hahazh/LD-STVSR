...
class context_extractor_layer(nn.Module):
    def __init__(self,in_c):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels=in_c, out_channels=32, kernel_size=3, stride=1, padding=1),
...
class light_context_extractor_layer(nn.Module):
    def __init__(self,in_c):
        super(light_context_extractor_layer, self).__init__()
        # 第一层
        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels=in_c, out_channels=32, kernel_size=3, stride=1, padding=1),
            nn.ReLU(inplace=False),
